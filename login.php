...
<head>
  ...
  <title>S-Brown | POS</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="" href="img/LOGO-ANAN-T.png" />
  <!-- Font Awesome -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <center><img width="250 px" src="img/LOGO-ANAN-T.png"><br>
    <h3><b>S-Brown POS   </b>2023</h3> <br><h4>Login</h4></center><br>
